            ...
            <div class="row align-items-center">
                <div
                    ...
                    <div class="header-top-links">
                        <ul>
                            <li><a href="#"><i class="fa fa-phone"></i>0868421280</a></li>
                            <li><a href="#"><i class="fa fa-envelope-open-o"></i>doanvietan173@gmail.gmail.com</a></li>
                        </ul>
                    </div>
                    <!--Links end-->
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-3 col-6 order-lg-1 order-md-1 order-1">
                    <div class="logo">
                        <a href="index.php"><img src="assets/images/logo.png" alt="logo TG shop"></a>
                    </div>
                </div>
                <!--Logo end-->
                ...
                <div class="col-lg-3 col-md-3 col-6 order-lg-3 order-md-3 order-2 d-flex justify-content-end">
                    ...
                    <div class="header-cart">
                        <a href="cart.php"><i class="fa fa-shopping-cart"></i><span>3</span></a>
                    </div>
                </div>
                <!--Search Cart End-->
            </div>
